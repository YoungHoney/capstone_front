...
function ExpandableComponent1() {
  ...
  return (
    <div>
      ...
      {isExpanded && <Timeline2></Timeline2>}
    </div>
  );
}
...
function ExpandableComponent2() {
    ...
    return (
      <div>
        ...
        {isExpanded && <FlowChart2></FlowChart2>}
      </div>
    );
  }
...
const ConvertButton = () => {
  ...
  return (
    <div>
      ...
      <Link to="/ancestor/virtual/김상익(金尙翼)">
      <button
        style={{
          position: 'fixed',
          bottom: '20px',
...
export default RealResultPage2;
